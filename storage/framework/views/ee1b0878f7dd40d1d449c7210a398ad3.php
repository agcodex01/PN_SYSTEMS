...
<div class="create-submission-container">
    ...
    <form action="<?php echo e(route('training.grade-submissions.store')); ?>" method="POST" class="submission-form">
        <?php echo csrf_field(); ?>
                ...
                <select name="school_id" id="school_id" required>
                    ...
                    <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($school->school_id); ?>" 
                            data-terms='<?php echo json_encode($school->terms, 15, 512) ?>'
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <span class="error-message-custom"><?php echo e($message); ?></span>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
             ...
             <div class="form-group-custom">
                ...
                <input type="text" name="academic_year" id="academic_year" placeholder="e.g., 2023-2024" required value="<?php echo e(old('academic_year')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-actions-custom">
            ...
            <a href="<?php echo e(route('training.grade-submissions.index')); ?>" class="btn-custom btn-secondary-custom">Cancel</a>
        </div>
    </form>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateTerms(terms) {
        ...
        const oldTerm = '<?php echo e(old('term')); ?>';
        if (oldTerm) {
    ...
    function populateClasses(classes) {
        ...
        // Select the old value if available
        const oldClass = '<?php echo e(old('class_id')); ?>';
        if (oldClass) {
    ...
    function populateSubjects(subjects) {
         ...
         const oldSubjects = <?php echo json_encode(old('subject_ids', []), 512) ?>;
    ...
    const oldSchoolId = '<?php echo e(old('school_id')); ?>';
    if (oldSchoolId) {
