...
<div class="create-user-page">
    ...
    <div class="page-header">
        <div class="header-content">
            <div class="header-left">
                <a href="{{ route('admin.pnph_users.index') }}" class="back-button">
    ...
    <div class="form-container">
        <div class="form-card">
            ...
            <form action="{{ route('admin.pnph_users.store') }}" method="POST" class="user-form" id="createUserForm">
                @csrf
