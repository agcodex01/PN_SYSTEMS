                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="grade-input-wrapper">
                                                ...
                                                <input type="text"
                                                       id="grade_input_<?php echo e($subject->id); ?>"
                                                       ...
                                                       list="grade_options_<?php echo e($subject->id); ?>"
                                                       placeholder="1.0-5.0 or select"
                                                       title="Enter a numeric grade (1.0-5.0) or select INC, NC, DR"
                                                       oninput="validateGradeInput(<?php echo e($subject->id); ?>)"
                                                       required>

                                                <!-- Datalist for dropdown options -->
                                                <datalist id="grade_options_<?php echo e($subject->id); ?>">
                                                ...
                                                <div id="grade_error_<?php echo e($subject->id); ?>" class="grade-error-message" style="display: none;">
