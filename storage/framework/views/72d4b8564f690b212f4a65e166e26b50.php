...
<div class="edit-student-container">
    ...
    <form action="<?php echo e(route('educator.students.update', $student->user_id)); ?>" method="POST" id="studentForm" onsubmit="return validateForm()">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo e(route('educator.students.index')); ?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.educator_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\PNPH-CAPSTONE\resources\views/educator/edit-student.blade.php ENDPATH**/ ?>