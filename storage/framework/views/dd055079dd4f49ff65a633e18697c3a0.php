...
<div class="page-container">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('training.intervention.index')); ?>" id="filterForm">
                ...
                <div class="filter-buttons">
                    ...
                    <a href="<?php echo e(route('training.intervention.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\PNPH-CAPSTONE\resources\views/training/intervention/index.blade.php ENDPATH**/ ?>