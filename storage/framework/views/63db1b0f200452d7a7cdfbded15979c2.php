...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <div class="greeting">
                Hello <?php echo e($student->user_fname); ?> <?php echo e($student->user_lname); ?>,
            </div>
            ...
            <div class="submission-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($gradeSubmission->school->name ?? 'N/A'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Class:</span>
                    <span class="detail-value"><?php echo e($gradeSubmission->classModel->class_name ?? 'N/A'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Semester:</span>
                    <span class="detail-value"><?php echo e($gradeSubmission->semester); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Term:</span>
                    <span class="detail-value"><?php echo e(ucfirst($gradeSubmission->term)); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Academic Year:</span>
                    <span class="detail-value"><?php echo e($gradeSubmission->academic_year); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Subjects:</span>
                    <span class="detail-value"><?php echo e($gradeSubmission->subjects->count()); ?> subject(s)</span>
                </div>
            </div>
            ...
            <div class="action-section">
                ...
                <a href="<?php echo e(url('/student/dashboard')); ?>" class="action-button">
...
<?php /**PATH C:\laravel\PNPH-CAPSTONE\resources\views/emails/grade-submission-notification.blade.php ENDPATH**/ ?>