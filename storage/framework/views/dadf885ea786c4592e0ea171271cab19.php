...
<div class="page-container">
    ...
    <form method="GET" action="<?php echo e(route('educator.students.index')); ?>" class="filter-form">
            ...
            <div class="table-row">
                ...
                <div class="cell">
                    <div class="action-buttons">
                        <a href="<?php echo e(route('educator.students.view', $student->user_id)); ?>" class="btn-icon" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="<?php echo e(route('educator.students.edit', $student->user_id)); ?>" class="btn-icon" title="Edit">
...
<?php echo $__env->make('layouts.educator_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\PNPH-CAPSTONE\resources\views/educator/students-info.blade.php ENDPATH**/ ?>